...
const features = [
  ...
  },
  {
    ...
    description: "Chứng chỉ hoàn thành được công nhận bởi các doanh nghiệp và trường đại học",
    highlight: "Được công nhận"
  },
  {
    icon: <Globe className="w-8 h-8" />,
    title: "Cộng đồng học viên",
    description: "Tham gia group Facebook 5000+ thành viên để luyện tập và trao đổi kinh nghiệm",
    highlight: "5000+ thành viên"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Tài liệu độc quyền",
    description: "Giáo trình được biên soạn riêng cho người Việt, cập nhật xu hướng thi JLPT mới nhất",
    highlight: "Cập nhật 2024"
  },
  {
    icon: <GraduationCap className="w-8 h-8" />,
    title: "Hỗ trợ sau tốt nghiệp",
    description: "Tư vấn việc làm, du học và kết nối với mạng lưới alumni thành công",
    highlight: "Trọn đời"
  }
];
